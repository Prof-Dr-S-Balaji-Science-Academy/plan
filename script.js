...
const CBSE10_CHAPTERS = [
    { id: 1, number: 1, title: 'Chemical Reactions', learning: 6, revision: 2, practice: 3, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 2, number: 2, title: 'Acids, Bases, Salts', learning: 8, revision: 3, practice: 4, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 3, number: 3, title: 'Metals & Non-metals', learning: 10, revision: 3, practice: 5, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 4, number: 4, title: 'Carbon Compounds', learning: 12, revision: 4, practice: 6, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 5, number: 1, title: 'Life Processes', learning: 14, revision: 5, practice: 6, subject: 'Biology', color: '#16a34a' },
    { id: 6, number: 2, title: 'Control & Coordination', learning: 8, revision: 3, practice: 4, subject: 'Biology', color: '#16a34a' },
    { id: 7, number: 3, title: 'Reproduction', learning: 10, revision: 4, practice: 5, subject: 'Biology', color: '#16a34a' },
    { id: 8, number: 4, title: 'Heredity', learning: 6, revision: 2, practice: 4, subject: 'Biology', color: '#16a34a' },
    { id: 9, number: 1, title: 'Light', learning: 14, revision: 5, practice: 8, subject: 'Physics', color: '#FF6B35' },
    { id: 10, number: 2, title: 'Human Eye', learning: 8, revision: 3, practice: 4, subject: 'Physics', color: '#FF6B35' },
    { id: 11, number: 3, title: 'Electricity', learning: 12, revision: 4, practice: 8, subject: 'Physics', color: '#FF6B35' },
    { id: 12, number: 4, title: 'Magnetic Effects', learning: 10, revision: 3, practice: 5, subject: 'Physics', color: '#FF6B35' },
    { id: 13, number: 1, title: 'Our Environment', learning: 5, revision: 2, practice: 3, subject: 'Environment', color: '#0891b2' }
];

const CBSE12_PHYSICS = [
    { id: 1, number: 1, title: 'Electric Charges and Fields', learning: 22, revision: 5.5, practice: 5, subject: 'Physics', color: '#FF6B35' },
    { id: 2, number: 2, title: 'Electrostatic Potential & Capacitance', learning: 18, revision: 4.5, practice: 5, subject: 'Physics', color: '#FF6B35' },
    { id: 3, number: 3, title: 'Current Electricity', learning: 11.7, revision: 2.9, practice: 5, subject: 'Physics', color: '#FF6B35' },
    { id: 4, number: 4, title: 'Moving Charges and Magnetism', learning: 14.5, revision: 3.6, practice: 5, subject: 'Physics', color: '#FF6B35' },
    { id: 5, number: 5, title: 'Magnetism and Matter', learning: 7.2, revision: 1.8, practice: 5, subject: 'Physics', color: '#FF6B35' },
    { id: 6, number: 6, title: 'Electromagnetic Induction', learning: 9.2, revision: 2.3, practice: 5, subject: 'Physics', color: '#FF6B35' },
    { id: 7, number: 7, title: 'Alternating Current', learning: 10.8, revision: 2.7, practice: 5, subject: 'Physics', color: '#FF6B35' },
    { id: 8, number: 8, title: 'Electromagnetic Waves', learning: 4.2, revision: 1.1, practice: 5, subject: 'Physics', color: '#FF6B35' },
    { id: 9, number: 9, title: 'Ray Optics & Optical Instruments', learning: 17, revision: 4.2, practice: 5, subject: 'Physics', color: '#FF6B35' },
    { id: 10, number: 10, title: 'Wave Optics', learning: 9.5, revision: 2.4, practice: 5, subject: 'Physics', color: '#FF6B35' },
    { id: 11, number: 11, title: 'Dual Nature of Radiation & Matter', learning: 6.4, revision: 1.6, practice: 5, subject: 'Physics', color: '#FF6B35' },
    { id: 12, number: 12, title: 'Atoms', learning: 6.4, revision: 1.6, practice: 5, subject: 'Physics', color: '#FF6B35' },
    { id: 13, number: 13, title: 'Nuclei', learning: 6.8, revision: 1.7, practice: 5, subject: 'Physics', color: '#FF6B35' },
    { id: 14, number: 14, title: 'Semiconductor Electronics', learning: 8.4, revision: 2.1, practice: 5, subject: 'Physics', color: '#FF6B35' }
];

const CBSE12_CHEMISTRY = [
    { id: 101, number: 1, title: 'Solutions', learning: 12, revision: 3, practice: 4, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 102, number: 2, title: 'Electrochemistry', learning: 14, revision: 4, practice: 5, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 103, number: 3, title: 'Chemical Kinetics', learning: 12, revision: 3, practice: 4, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 104, number: 4, title: 'd- and f-Block Elements', learning: 10, revision: 4, practice: 3, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 105, number: 5, title: 'Coordination Compounds', learning: 12, revision: 3, practice: 4, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 106, number: 6, title: 'Haloalkanes and Haloarenes', learning: 12, revision: 4, practice: 4, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 107, number: 7, title: 'Alcohols, Phenols and Ethers', learning: 14, revision: 4, practice: 5, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 108, number: 8, title: 'Aldehydes, Ketones and Carboxylic Acids', learning: 16, revision: 5, practice: 6, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 109, number: 9, title: 'Amines', learning: 10, revision: 3, practice: 4, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 110, number: 10, title: 'Biomolecules', learning: 10, revision: 3, practice: 3, subject: 'Chemistry', color: '#0d2ad4' }
];

const STATE_BOARD_PHYSICS = [
    { id: 201, number: 1, title: 'Electrostatics', learning: 30, revision: 5, practice: 8, subject: 'Physics', color: '#FF6B35' },
    { id: 202, number: 2, title: 'Current Electricity', learning: 18, revision: 3, practice: 6, subject: 'Physics', color: '#FF6B35' },
    { id: 203, number: 3, title: 'Magnetism & Magnetic Effects', learning: 27, revision: 5, practice: 8, subject: 'Physics', color: '#FF6B35' },
    { id: 204, number: 4, title: 'EMI and Alternating Current', learning: 27, revision: 5, practice: 8, subject: 'Physics', color: '#FF6B35' },
    { id: 205, number: 5, title: 'Electromagnetic Waves', learning: 7, revision: 2, practice: 4, subject: 'Physics', color: '#FF6B35' },
    { id: 206, number: 6, title: 'Ray Optics', learning: 22, revision: 4, practice: 6, subject: 'Physics', color: '#FF6B35' },
    { id: 207, number: 7, title: 'Wave Optics', learning: 24, revision: 4, practice: 7, subject: 'Physics', color: '#FF6B35' },
    { id: 208, number: 8, title: 'Dual Nature of Radiation', learning: 13, revision: 3, practice: 5, subject: 'Physics', color: '#FF6B35' },
    { id: 209, number: 9, title: 'Atomic and Nuclear Physics', learning: 22, revision: 4, practice: 7, subject: 'Physics', color: '#FF6B35' },
    { id: 210, number: 10, title: 'Electronics & Communication', learning: 24, revision: 4, practice: 7, subject: 'Physics', color: '#FF6B35' },
    { id: 211, number: 11, title: 'Recent Developments in Physics', learning: 9, revision: 2, practice: 4, subject: 'Physics', color: '#FF6B35' }
];

const STATE_BOARD_CHEMISTRY = [
    { id: 301, number: 1, title: 'Metallurgy', learning: 6, revision: 2, practice: 3, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 302, number: 2, title: 'p-Block Elements-I', learning: 8, revision: 3, practice: 4, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 303, number: 3, title: 'p-Block Elements-II', learning: 12, revision: 4, practice: 5, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 304, number: 4, title: 'Transition & Inner Transition', learning: 8, revision: 3, practice: 4, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 305, number: 5, title: 'Coordination Chemistry', learning: 12, revision: 4, practice: 5, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 306, number: 6, title: 'Solid State', learning: 7, revision: 2, practice: 3, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 307, number: 7, title: 'Chemical Kinetics', learning: 9, revision: 3, practice: 4, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 308, number: 8, title: 'Ionic Equilibrium', learning: 10, revision: 3, practice: 4, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 309, number: 9, title: 'Electro Chemistry', learning: 11, revision: 4, practice: 5, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 310, number: 10, title: 'Surface Chemistry', learning: 7, revision: 2, practice: 3, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 311, number: 11, title: 'Hydroxy Compounds & Ethers', learning: 12, revision: 4, practice: 5, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 312, number: 12, title: 'Carbonyl Compounds & Acids', learning: 15, revision: 5, practice: 6, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 313, number: 13, title: 'Organic Nitrogen Compounds', learning: 10, revision: 3, practice: 4, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 314, number: 14, title: 'Biomolecules', learning: 7, revision: 2, practice: 3, subject: 'Chemistry', color: '#0d2ad4' },
    { id: 315, number: 15, title: 'Everyday Life & Polymers', learning: 4, revision: 1, practice: 2, subject: 'Chemistry', color: '#0d2ad4' }
];
...
function renderHours() {
    ...
    DAYS.forEach(day => {
        ...
        html += `<div class="hour-input">
            ...
            <input type="range" min="0" max="8" step="0.5" value="${hours}" oninput="updateHours('${day}', this.value)" style="outline: none;">
...
function computeSchedule(chapters, hoursByDay) {
    ...
    const januaryStart = new Date(startDate.getFullYear() + 1, 0, 1);
    ...
    // Track daily allocations to prevent overlaps
    const dailyAllocations = {};
    
    // PHASE 1: LEARNING (only before Dec 31)
    chapters.forEach(ch => {
        if (!ch.learning) return;
        let remainingHours = ch.learning;
        let currentDate = new Date(startDate);
        
        while (remainingHours > 0 && currentDate <= decemberEnd) {
            ...
            if (availableHours > 0) {
                ...
                schedule.byPhase.learning.push({
                    chapter: ch,
                    phase: 'Learning',
    ...
    // PHASE 2: REVISION (only in December, after learning)
    chapters.forEach(ch => {
        const revisionHours = Math.ceil((ch.learning || 0) * 0.4);
        if (!revisionHours) return;
        
        // Start revision from Dec 15 (middle of month)
        let currentDate = new Date(startDate.getFullYear(), 10, 15);
        if (currentDate < startDate) currentDate = new Date(startDate);
        
        let remainingHours = revisionHours;
        ...
        while (remainingHours > 0 && currentDate <= decemberEnd) {
            ...
            if (availableHours > 0) {
                ...
                schedule.byPhase.revision.push({
                    chapter: ch,
                    phase: 'Revision',
                    date: new Date(currentDate),
                    hours: hoursToAllocate,
    ...
    // PHASE 3: PRACTICE (only in January)
    chapters.forEach(ch => {
        const practiceHours = Math.ceil((ch.learning || 0) * 0.3);
        if (!practiceHours) return;
        
        let currentDate = new Date(januaryStart);
        let remainingHours = practiceHours;
        ...
        while (remainingHours > 0 && currentDate <= targetDate) {
            ...
            if (availableHours > 0) {
                ...
                schedule.byPhase.practice.push({
                    chapter: ch,
                    phase: 'Practice',
                    date: new Date(currentDate),
                    hours: hoursToAllocate,
                ...
                <tbody>
                    ${plan.included.map((ch, idx) => {
                        ...
                        return `<tr style="background: ${bg}; border-bottom: 1px solid #ddd;">
                            <td style="padding: 10px; border: 1px solid #ddd;"><strong>${ch.number}. ${ch.title}</strong></td>
