...
function downloadPDF() {
    ...
    let html = `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; padding: 40px; background: white;">
            <div style="text-align: center; margin-bottom: 40px; padding-bottom: 20px; border-bottom: 2px solid #0d2ad4;">
                <h1 style="color: #0d2ad4; margin: 0 0 10px 0; font-size: 28px;">Personalised Study Plan</h1>
                <p style="color: #666; font-size: 14px; margin: 5px 0;">CBSE Class 10 Science • Generated ${timestamp}</p>
            </div>
    ...
    stats.forEach(stat => {
        html += `
            <div style="background: #eef2ff; padding: 15px; border-radius: 8px; text-align: center;">
                <div style="color: #0d2ad4; font-weight: 900; font-size: 24px;">${stat.value}</div>
                <div style="color: #666; font-size: 12px; font-weight: 600; margin-top: 5px;">${stat.label}</div>
            </div>
        `;
    });
    ...
    html += `
            ...
            <h2 style="color: #0d2ad4; font-size: 18px; margin-bottom: 15px; border-bottom: 2px solid #0d2ad4; padding-bottom: 10px;">Chapter Schedule</h2>
            <table style="width: 100%; border-collapse: collapse; font-size: 12px; margin-bottom: 30px;">
                <thead>
                    <tr style="background: #0d2ad4; color: white;">
                        <th style="padding: 10px; text-align: left; border: 1px solid #ccc;">#</th>
                        <th style="padding: 10px; text-align: left; border: 1px solid #ccc;">Chapter</th>
                        <th style="padding: 10px; text-align: left; border: 1px solid #ccc;">Subject</th>
                        <th style="padding: 10px; text-align: center; border: 1px solid #ccc;">Phase</th>
                        <th style="padding: 10px; text-align: center; border: 1px solid #ccc;">Hours</th>
                        <th style="padding: 10px; text-align: center; border: 1px solid #ccc;">Dates</th>
                    </tr>
                </thead>
                <tbody>
    `;
        ...
        if (ch) {
            html += `
                <tr style="background: #f0fdf4; opacity: 0.7;">
                    <td style="padding: 8px; border: 1px solid #ddd;">${ch.id}</td>
                    <td style="padding: 8px; border: 1px solid #ddd;">${ch.title}</td>
                    <td style="padding: 8px; border: 1px solid #ddd;">${ch.subject}</td>
                    <td colspan="3" style="padding: 8px; border: 1px solid #ddd; color: #16a34a; font-weight: 700;">✓ Already Completed</td>
                </tr>
            `;
        }
    }
    ...
    for (const item of plan.items) {
        ...
        html += `
            <tr style="border-bottom: 1px solid #ddd;">
                ...
                <td style="padding: 8px; border: 1px solid #ddd;">${ch.title}</td>
                <td style="padding: 8px; border: 1px solid #ddd;">${ch.subject}</td>
                <td style="padding: 8px; border: 1px solid #ddd; text-align: center; font-weight: 700; color: ${PHASE_COLORS[item.phase]};">Phase ${item.phase}</td>
                <td style="padding: 8px; border: 1px solid #ddd; text-align: center; font-weight: 700;">${Math.round(item.hours)}h</td>
                <td style="padding: 8px; border: 1px solid #ddd; text-align: center; font-size: 11px;">${formatDate(item.startDate)} → ${formatDate(item.endDate)}</td>
            </tr>
        `;
    }
    ...
    html += `
            ...
            <div style="background: #eef2ff; padding: 15px; border-radius: 8px; font-size: 12px; line-height: 1.8; margin-bottom: 20px;">
            ...
            <div style="text-align: center; color: #999; font-size: 11px; border-top: 1px solid #ddd; padding-top: 20px;">
